...
export default function AdminStopModal({ isOpen, onClose, onConfirm, isStopping }) {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4" aria-modal="true" role="dialog">
      ...
      <div 
        ...
        onClick={!isStopping ? onClose : undefined}
      ></div>
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-sm overflow-hidden transform transition-all scale-100 animate-fadeInUp">
        ...
        <div className="p-6 text-center">
          {/* Iconiță Animată Pulsatorie */}
          <div className="mx-auto flex items-center justify-center h-16 w-16 rounded-full bg-red-50 mb-5 animate-pulse">
            <RiStopCircleLine className="h-9 w-9 text-red-600" />
          </div>
          
          <h3 className="text-xl font-bold text-gray-900 mb-2">
            Oprire Forțată Pipeline?
          </h3>
          
          <p className="text-sm text-gray-500 leading-relaxed">
            Ești pe cale să oprești procesul <strong>Scraper & AI</strong>. 
            <br/>
            Această acțiune va întrerupe imediat colectarea datelor și procesarea curentă.
          </p>
        </div>
